...
async def generate_summary_route(request: SummaryRequest, http_request: Request, db: AsyncSession = Depends(get_session)):
    ...
    try:
        ...
        summary_data_to_store = WeeklySummary(
            ...
            stats=request.week_stats.model_dump(), # Ensure stats is a dict if model expects it
